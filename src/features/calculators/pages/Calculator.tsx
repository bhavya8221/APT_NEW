...
import Banner from "@/components/layout/Banner"; // ✔ FIXED PATH
import { GetCalculatorDescription } from "@/utils/api/Api";
import { Image_URL } from "@/utils/constants/host";

import Signin from "@/features/auth/Signin"; // ✔ FIXED PATH
...
const Calculator: React.FC<CalculatorProps> = ({ children }) => {
  ...
  useEffect(() => {
    window.scrollTo({ top: 0, left: 0, behavior: "auto" }); // ✔ FIX
  }, []);
